...
class View
{
    ...
    public function generateError($datas)
    {
        // Génération de la partie spécifique de la vue
        $content = $this->generateFile($this->file, $datas);
        // On définit une variable locale accessible par la vue pour la racine Web
        ...
        $rootWeb = Configuration::get("rootWeb", "/");
        // Génération du template commun utilisant la partie spécifique
        $view    = $this->generateFile('View/themes/errors/index.php', array(
        //$view    = $this->generateFile('View/themes/front/template.php', array(
            'title' => $this->title,
            'content' => $content,
            'sidebar' => $this->sidebar,
    ...
    public function generateAdminError($datas)
    {
        // Génération de la partie spécifique de la vue
        $content = $this->generateFile($this->file, $datas);
        // On définit une variable locale accessible par la vue pour la racine Web
        ...
        $rootWeb = Configuration::get("rootWeb", "/");
        // Génération du template commun utilisant la partie spécifique
        $view    = $this->generateFile('View/themes/back/errors.php', array(
        //$view    = $this->generateFile('View/themes/front/template.php', array(
            'title' => $this->title,
            'content' => $content,
            'sidebar' => $this->sidebar,
