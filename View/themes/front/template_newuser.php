...
<a href="<?= DOMAIN_NAME; ?>" target="_blank"><img class="  " width="150" src="<?= DOMAIN_NAME; ?>public/images/logos/logo-xl.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;"></a>
...
<table class="s-4 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
  ...
  <tbody>
    <tr>
      <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0;" align="left">
        <img width="25" height="25" class="" src="<?= DOMAIN_NAME; ?>public/images/icons/security.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;">
      </td>
    </tr>
  </tbody>
</table>

      <h4 class="text-center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; color: inherit; vertical-align: baseline; font-size: 24px; line-height: 28.8px;" align="center">Hey, <?= USER_ALIAS; ?></h4>
      <br>
      <p class="text-center" style="line-height: 24px; font-size: 16px; margin: 0;" align="center">Merci d'avoir rejoint <?= WEBSITE_NAME; ?> !</p>
