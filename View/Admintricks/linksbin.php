	  ...
	  <table class="table table-striped table-sm">
	    ...
	    <tbody>
	      ...
	      <tr>
	        ...
	        <td><a href="<?= BASE_ADMIN_URL. 'restorethislink/' . $this->clean($link['id'])?>" role="button" class="btn btn-sm btn-success">Restaurer</a></td>
	        <td><a href="<?= BASE_ADMIN_URL. 'removelink/' . $this->clean($link['id'])?>" role="button" class="btn btn-sm btn-danger">Supprimer définitivement</a></td>
	      </tr>
	      <?php
	        }
	      ?>
		...
		<div class="d-flex flex-row-reverse btn-toolbar mb-3 mb-md-0">
			<div class="btn-group mr-2">
				<a href="<?= BASE_ADMIN_URL; ?>emptylinks" role="button" class="float-right btn btn-sm btn-dark">Vider la Corbeille</a>
			</div>
		</div>
	</div>
<?php };  ?>
