    ...
    <tbody>
      ...
      <tr>
        ...
        <?= $this->clean($category['name']); ?></a></span></td>
				...
				<td><a href="<?= BASE_ADMIN_URL. 'categoryread/' . $this->clean($category['id'])?>" role="button" class="btn btn-sm btn-primary">Modifier</a></td>
        <td><a href="<?= BASE_ADMIN_URL. 'movecategorytobin/' . $this->clean($category['id'])?>" role="button" class="btn btn-sm btn-danger">Supprimer</a></td>
		  </tr>
      <?php
        }
      ?>
