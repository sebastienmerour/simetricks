...
<div class="media mb-4">
  ...
  <div class="media-body">
      <form role="form" class="form needs-validation" action="<?= BASE_ADMIN_URL; ?>updatecommentreported/<?= $this->clean($comment['id']);?>" method="post" id="commentmodification" novalidate>
