...
<div class="media mb-4">
  ...
  <div class="media-body">
      <form role="form" class="form needs-validation" action="<?= BASE_ADMIN_URL; ?>updatecomment/<?= $this->clean($comment['id']);?>" method="post" id="commentmodification" novalidate>
        ...
        <div class="form-group">
             <div class="col-xs-12">
                  <br>
									...
									<a href="<?= BASE_ADMIN_URL. 'removecomment/' . $this->clean($comment['id']) ;?>" role="button" class="btn btn-danger">Supprimer définitivement</a>
