...
<div class="card my-4">
    ...
    <div class="card-body">
				<form role="form" class="form needs-validation" action="<?= BASE_ADMIN_URL; ?>updatecategory/<?= $this->clean($category['id']);?>" method="post"
		...
		<div class="form-group">
				 <div class="col-xs-12">
							...
							<a href="<?= BASE_ADMIN_URL. 'removecategory/' . $this->clean($category['id'])?>" role="button" class="btn btn-md btn-danger">Supprimer définitivement</a>
