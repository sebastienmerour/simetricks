...
<div class="table-responsive">
	<table class="table table-striped table-sm">
      ...
      <tr>
        ...
        <td><a href="<?= BASE_ADMIN_URL. 'extendedcardread/' . $this->clean($item['itemid'])?>" role="button" class="btn btn-sm btn-primary">Modifier</a></td>
        <td><a href="<?= BASE_ADMIN_URL. 'moveitemtobin/' . $this->clean($item['itemid'])?>" role="button" class="btn btn-sm btn-danger">Supprimer</a></td>
		  </tr>
      <?php
        }
      ?>
