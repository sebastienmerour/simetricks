...
<div>
    ...
    <?php } ?><br>
    Catégorie : <a href="category/<?= $this->clean($category['id']) ;?>/1"><?= $this->clean($category['name']); ?></a> |&nbsp;<a href="<?= !ISSET($_SESSION['id_user']) ? "item/" . $this->clean($item['itemid'])  . "/1/#comments" : "item/indexuser/" . $this->clean($item['itemid']). "/1/#comments" ?>">Commentaires (<?= $number_of_comments ;?>)</a><br>
    </div>
  </div>
</div>
</div>
