...
<div class="row justify-content-between align-items-center">
  ...
  if ($items_current_page > $number_of_items_pages) {
    require __DIR__ . '/../errors/page_not_found.php';
        ...
        {
        ?>
    <a href="<?= BASE_URL; ?>extendedcards/<?= $previous_page; ?>" class="btn btn-outline-white">Préc</a>
  <?php
  }; ?>
  ...
  <div class="col-auto">
          ...
          if($items_current_page == $i)
            {
              ...
              echo ' class="page-item active"><a class="page-link" href="'. BASE_URL . 'extendedcards/' . $i . '">' . $i . '</a></li>';
            }
        };?>
        </ul>
      </nav>
    ...
    <?php if ($items_current_page < $number_of_items_pages)
        {
        ?><a href="<?= BASE_URL; ?>extendedcards/<?= $next_page; ?>" class="btn btn-outline-white">Suiv</a><?php };?>
      </div>
      <?php };?>
</div>
