<div class="tab-content" id="pills-tabContent">
      <div class="tab-pane fade show active p-2" id="infos" role="tabpanel" aria-labelledby="pills-home-tab">
        <form role="form" class="form needs-validation" action="user/updateuserinfos" method="post" id="usermodification" novalidate>
          <div class="row">
            <div class="col-6">
              ...
              <div class="form-group">
                <div class="col-xs-6">
                  <label class="pl-1" for="city">Ville :</label>
                    <input type="text" class="form-control" name="city" id="city" value="<?php echo $user['city'] ?>" title="Modifiez votre ville si besoin">
                </div>
              </div>
            </div>
            <div class="col-6">
            <div class="form-group">
              <div class="col-xs-6">
                <label class="pl-1" for="linkedin">Linkedin :</label>
                  <input type="text" class="form-control" name="linkedin" id="linkedin" value="<?php echo $user['linkedin'] ?>" title="Modifiez votre page Linkedin si besoin">
              </div>
            </div>
            <div class="form-group">
              <div class="col-xs-6">
                <label class="pl-1" for="github">Github :</label>
                  <input type="text" class="form-control" name="github" id="github" value="<?php echo $user['github'] ?>" title="Modifiez votre page Github si besoin">
              </div>
            </div>
            <div class="form-group">
              <div class="col-xs-6">
                <label class="pl-1" for="twitter">Twitter :</label>
                  <input type="text" class="form-control" name="twitter" id="twitter" value="<?php echo $user['twitter'] ?>" title="Modifiez votre page Twitter si besoin">
              </div>
            </div>
            <div class="form-group">
              <div class="col-xs-6">
                <label class="pl-1" for="website">Site Web :</label>
                  <input type="text" class="form-control" name="website" id="website" value="<?php echo $user['website'] ?>" title="Modifiez l'adresse de votre site web si besoin">
              </div>
            </div>
          </div>
        </div>
...
<form role="form" class="form needs-validation" action="user/updateuserusername" method="post" id="usermodification" novalidate>
  <div class="form-group">
      <div class="col-xs-6">
...
<form role="form" class="form needs-validation" action="user/updateuserpassword" method="post" id="usermodification" novalidate>
  <div class="form-group">
    <div class="col-xs-6">
  ...
  <div class="form-group">
    <div class="col-xs-12">
      <button class="btn btn-md btn-success" name="edituserpass" type="submit">Enregistrer</button>
      <a href="#"><button class="btn btn-md btn-secondary" type="reset">Annuler</button></a>
      <a href="<?= $_SERVER['HTTP_REFERER']; ?>"><button class="btn btn-md btn-primary" type="button">Retour</button></a>
    </div>
    </div>
