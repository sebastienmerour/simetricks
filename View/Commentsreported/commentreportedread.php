...
<div class="media mb-4">
  ...
  <div class="media-body">
      <form role="form" class="form needs-validation" action="<?= BASE_ADMIN_URL; ?>commentsreported/updatecommentreported/<?= $this->clean($comment['id']);?>" method="post" id="commentmodification" novalidate>
        ...
        <div class="form-group">
             <div class="col-xs-12">
                  ...
                  <button class="btn btn-md btn-success" name="modify" type="submit">Modifier</button>
									<a href="<?= BASE_ADMIN_URL. 'commentsreported/approve/' . $this->clean($comment['id']) ;?>" role="button" class="btn btn-warning">Approuver</a>
									<a href="<?= BASE_ADMIN_URL. 'commentsreported/removecommentreported/' . $this->clean($comment['id']) ;?>" role="button" class="btn btn-danger">Supprimer définitivement</a>
